...
<div class="row col-md-4 col-md-offset-4">
  ...
  <?php
    if($ac == 1) 
    {
      echo '<form action="index.php?action=hanghoa&&id='.$id.'&&act=edit_action" method="post" enctype="multipart/form-data">';
    }
    if($ac == 2) 
    {
      echo '<form action="index.php?action=hanghoa&&act=insert" method="post" enctype="multipart/form-data">';
    }
  ?>
    <table class="table" style="border: 0px;">
      ...
      <tr>
        ...
        <td>
          <select name="maloai" class="form-control" style="width:150px;">
            ...
            ?>
              <option <?php if(isset($_GET['id'])) {if ($maloai == $set['maloai']) echo "selected";} ?> value="<?php echo $set['maloai']; ?>"><?php echo $set['maloai']; ?></option>
            <?php
            endwhile;
            ?>
          </select>
      ...
      <tr>
        <td>Số lượt xem</td>
        <td><input type="text" class="form-control" name="slx" value="<?php if (isset($soluongxem)) echo $soluongxem; ?>">
        </td>
      </tr>
      <tr>
        <td>Ngày lập</td>
      ...
      <!-- <tr>
        <td>Toping</td>
        <td><input type="text" class="form-control" name="mausac" value="<?php if (isset($mausac)) echo $mahh; ?>">
        </td>
      </tr>
      <tr>
        <td>Size</td>
